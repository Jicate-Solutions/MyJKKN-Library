-- =====================================================
-- Exam Attendance Report Function
-- =====================================================
-- Purpose: Generate attendance report data for PDF generation
...
BEGIN
	...
	SELECT
		...
		-- Course Info
		c.course_code,
		COALESCE(c.course_title, c.course_name) AS course_name,
		COALESCE(c.course_category, '-') AS course_category,
	...
	GROUP BY
		...
		c.course_code, c.course_name, c.course_title, c.course_category
