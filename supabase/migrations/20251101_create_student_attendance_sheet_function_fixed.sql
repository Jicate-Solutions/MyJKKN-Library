-- =====================================================
-- Student Attendance Sheet Function (FIXED)
-- =====================================================
-- Purpose: Generate student-wise attendance sheets for PDF generation
-- Fixed: Changed course_title to course_name
-- =====================================================
...
BEGIN
	...
	SELECT
		...
		c.course_code,
		c.course_name AS course_title,  -- FIXED: Using course_name instead of course_title
		p.program_code,
		p.program_name,
	...
	ORDER BY et.exam_date, et.session, c.course_code, p.program_code, s.register_no;
END;
...
COMMENT ON FUNCTION get_student_attendance_sheet IS 'Generates student-wise attendance sheets for PDF generation';
