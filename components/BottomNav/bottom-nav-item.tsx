...
export function BottomNavItem({
  ...
  return (
    <motion.button
      onClick={onClick}
      className={cn(
        'relative flex flex-col items-center justify-center px-1 py-2 min-w-[64px] flex-1',
    ...
    >
      ...
      <motion.span
        className={cn(
          'text-[10px] mt-1 font-medium leading-tight text-center line-clamp-2 max-w-full',
