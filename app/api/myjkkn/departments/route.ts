...
import { fetchMyJKKNDepartments, MyJKKNApiError } from '@/lib/myjkkn-api'
...
export async function GET(request: NextRequest) {
	try {
		...
		console.error('Error fetching departments from MyJKKN:', error)
		...
		return NextResponse.json(
			{ error: 'Failed to fetch departments from MyJKKN' },
			{ status: 500 }
		)
	}
}
